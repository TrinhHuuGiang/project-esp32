...
{
    xSemaphoreTake(g_task_sync_tools->i2c_master_handle_mutex, portMAX_DELAY);
}

// get periph mutex
void release_i2c_master_mutex()
{
    xSemaphoreGive(g_task_sync_tools->i2c_master_handle_mutex);
}
